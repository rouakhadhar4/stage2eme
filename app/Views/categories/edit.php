    ...
    <div class="container mt-5 content">
        <div class="card mx-auto" style="max-width: 400px;">
            <div class="card-header" style="background-color:  #0046fd; color: white; text-align: center;">
                <h2 class="mb-0" style="color: black;">Edit Category</h2>
            </div>
            <div class="card-body" style="max-height: 500px; overflow-y: auto;">
                <?= form_open("/categories/update/{$category['idcategory']}", ['class' => 'mt-4 mx-auto']); ?>
                <div class="mb-3">
                ...
                <div class="d-grid">
                    <button type="submit" style="background-color:  #0046fd; color: black; text-align: center;">Update</button>
                </div>
                <?= form_close(); ?>
            </div>
        </div>
