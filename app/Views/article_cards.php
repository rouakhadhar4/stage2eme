...
<head>
    ...
    <style>
        ...
        .card {
    height: 100%; /* Hauteur fixe pour chaque carte */
}
...
<body>
    ...
    <div>
    <div class="container">
        <img src="/public/images/image.jpg" alt="Meuble de salon pas cher" width="1150">
        <div class="text">
...
<div class="footer-area">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        Elegance Deco as been the industry's standard dummy text ever since the 1500s
                        </p>
                    </div>
                    <div class="col-md-3">
